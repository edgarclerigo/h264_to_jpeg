...
decode: hw_decode.c tracker.h chunk.h ffmpeg ujsonin/ujsonin.c ujsonin/ujsonin.h
	...
	gcc -g hw_decode.c ujsonin/ujsonin.c ujsonin/red_black_tree.c ujsonin/string-tree.c -I /opt/homebrew/include -framework CoreVideo -L /opt/homebrew/lib -lavcodec -lavutil -lavformat -lturbojpeg -lswscale -lzmq -lnanomsg -o decode
...
send: send_video.c tracker.h chunk.h
	./brewser.pl installdeps brew_deps
	gcc send_video.c ujsonin/ujsonin.c ujsonin/red_black_tree.c ujsonin/string-tree.c -I /opt/homebrew/include -L /opt/homebrew/lib -lzmq -lnanomsg -o send
